...
!function (e, t) {
    ...
    function u(e, t, n) {
        var r;
        if (void 0 === n && 1 === e.nodeType)if (r = "data-" + t.replace(Dt, "-$&").toLowerCase(), n = e.getAttribute(r), "string" == typeof n) {
            try {
    ...
    function p(e, t, n, r, i) {
        for (var o, s, a, u, l, p, d = t.createDocumentFragment(), h = [], g = 0, m = e.length; m > g; g++)if (o = e[g], o || 0 === o)if ("object" === ot.type(o)) ot.merge(h, o.nodeType ? [o] : o); else if (Rt.test(o)) {
        ...
        for (d.textContent = "", g = 0; o = h[g++];)if (r && ot.inArray(o, r) > -1) i && i.push(o); else if (l = ot.contains(o.ownerDocument, o), s = c(d.appendChild(o), "script"), l && f(s), n)for (p = 0; o = s[p++];)Ft.test(o.type || "") && n.push(o);
        return d
    }
    ...
    function T(e, t, n, r) {
        ...
        if (d && (i = p(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            for (s = ot.map(c(i, "script"), y), a = s.length; d > f; f++)u = i, f !== h && (u = ot.clone(u, !0, !0), a && ot.merge(s, c(u, "script"))), n.call(e[f], u, f);
            if (a)for (l = s[s.length - 1].ownerDocument, ot.map(s, x), f = 0; a > f; f++)u = s[f], Ft.test(u.type || "") && !Et.access(u, "globalEval") && ot.contains(l, u) && (u.src ? ot._evalUrl && ot._evalUrl(u.src) : ot.globalEval(u.textContent.replace(zt, "")))
        }
        return e
    }

    function C(e, t, n) {
        for (var r, i = t ? ot.filter(t, e) : e, o = 0; null != (r = i[o]); o++)n || 1 !== r.nodeType || ot.cleanData(c(r)), r.parentNode && (n && ot.contains(r.ownerDocument, r) && f(c(r, "script")), r.parentNode.removeChild(r));
        return e
    }
    ...
    function E(e) {
        var t = G, n = Vt[e];
        return n || (n = k(e, t), "none" !== n && n || (Ut = (Ut || ot("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Ut[0].contentDocument, t.write(), t.close(), n = k(e, t), Ut.detach()), Vt[e] = n), n
    }

    function N(e, t, n) {
        var r, i, o, s, a = e.style;
        return n = n || Qt(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== s && void 0 !== s || ot.contains(e.ownerDocument, e) || (s = ot.style(e, t)), n && !rt.pixelMarginRight() && Gt.test(s) && Yt.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o), void 0 !== s ? s + "" : s
    }
    ...
    function A(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2)"margin" === n && (s += ot.css(e, n + qt[o], !0, i)), r ? ("content" === n && (s -= ot.css(e, "padding" + qt[o], !0, i)), "margin" !== n && (s -= ot.css(e, "border" + qt[o] + "Width", !0, i))) : (s += ot.css(e, "padding" + qt[o], !0, i), "padding" !== n && (s += ot.css(e, "border" + qt[o] + "Width", !0, i)));
        return s
    }

    function q(t, n, r) {
        var i = !0, o = "width" === n ? t.offsetWidth : t.offsetHeight, s = Qt(t), a = "border-box" === ot.css(t, "boxSizing", !1, s);
        if (G.msFullscreenElement && e.top !== e && t.getClientRects().length && (o = Math.round(100 * t.getBoundingClientRect()[n])), 0 >= o || null == o) {
            if (o = N(t, n, s), (0 > o || null == o) && (o = t.style[n]), Gt.test(o))return o;
            i = a && (rt.boxSizingReliable() || o === t.style[n]), o = parseFloat(o) || 0
        }
        return o + A(t, n, r || (a ? "border" : "content"), i, s) + "px"
    }

    function L(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)r = e[s], r.style && (o[s] = Et.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && Lt(r) && (o[s] = Et.access(r, "olddisplay", E(r.nodeName)))) : (i = Lt(r), "none" === n && i || Et.set(r, "olddisplay", i ? n : ot.css(r, "display"))));
    ...
    function R(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], l = ot.css(e, "display"), c = "none" === l ? Et.get(e, "olddisplay") || E(e.nodeName) : l, "inline" === c && "none" === ot.css(e, "float") && (d.display = "inline-block")), n.overflow && (d.overflow = "hidden", f.always(function () {
        ...
        if (ot.isEmptyObject(p)) "inline" === ("none" === l ? E(e.nodeName) : l) && (d.display = l); else {
            g ? "hidden" in g && (h = g.hidden) : g = Et.access(e, "fxshow", {}), o && (g.hidden = !h), h ? ot(e).show() : f.done(function () {
                    ot(e).hide()
                }), f.done(function () {
                var t;
                Et.remove(e, "fxshow");
    ...
    function I(e, t, n) {
        ...
        for (M(c, l.opts.specialEasing); s > o; o++)if (r = I.prefilters[o].call(l, e, c, l.opts))return ot.isFunction(r.stop) && (ot._queueHooks(l.elem, l.opts.queue).stop = ot.proxy(r.stop, r)), r;
    ...
    function U(e, t, n, r) {
        ...
        }); else if (n || "object" !== ot.type(t)) r(e, t); else for (i in t)U(e + "[" + i + "]", t[i], n, r)
    }
    ...
    var Y = [], G = e.document, Q = Y.slice, J = Y.concat, K = Y.push, Z = Y.indexOf, et = {}, tt = et.toString, nt = et.hasOwnProperty, rt = {}, it = "2.2.3", ot = function (e, t) {
        return new ot.fn.init(e, t)
    }, st = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, at = /^-ms-/, ut = /-([\da-z])/gi, lt = function (e, t) {
    ...
    ot.fn = ot.prototype = {
        ...
        for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == typeof s || ot.isFunction(s) || (s = {}), a === u && (s = this, a--); u > a; a++)if (null != (e = arguments[a]))for (t in e)n = s[t], r = e[t], s !== r && (l && r && (ot.isPlainObject(r) || (i = ot.isArray(r))) ? (i ? (i = !1, o = n && ot.isArray(n) ? n : []): o= n && ot.isPlainObject(n) ? n : {}, s[t] = ot.extend(l, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }, ot.extend({
        expando: "jQuery" + (it + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var n, r, i;
            return "string" == typeof t && (n = e[t], t = e, e = n), ot.isFunction(e) ? (r = Q.call(arguments, 2), i = function () {
                    return e.apply(t || this, r.concat(Q.call(arguments)))
                }, i.guid = e.guid = e.guid || ot.guid++, i) : void 0
        }, now: Date.now, support: rt
    }), "function" == typeof Symbol && (ot.fn[Symbol.iterator] = Y[Symbol.iterator]), ot.each("Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "), function (e, t) {
    ...
    var ct = function (e) {
        ...
        function y(e) {
            for (var t, n, r, i = e.length, o = T.relative[e[0].type], s = o || T.relative[" "], a = o ? 1 : 0, u = d(function (e) {
                ...
                if (n = T.filter[e[a].type].apply(null, e[a].matches), n[I]) {
                    ...
                    return v(a > 1 && h(c), a > 1 && p(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(at, "$1"), n, r > a && y(e.slice(a, r)), i > r && y(e = e.slice(r)), i > r && p(e))
                }
                c.push(n)
            }
            return h(c)
        ...
        function x(e, n) {
            var i = n.length > 0, o = e.length > 0, s = function (r, s, a, u, l) {
                var c, f, p, d = 0, h = "0", g = r && [], v = [], y = D, x = r || o && T.find.TAG("*", l), b = $ += null == y ? 1 : Math.random() || .1, w = x.length;
        ...
        var b, w, T, C, k, E, N, S, D, j, A, q, L, H, O, F, P, R, M, I = "sizzle" + 1 * new Date, W = e.document, $ = 0, B = 0, _ = n(), X = n(), z = n(), U = function (e, t) {
            return e === t && (A = !0), 0
        ...
        w = t.support = {}, k = t.isXML = function (e) {
            ...
            return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = L.documentElement, O = !k(L), (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Tt, !1) : n.attachEvent && n.attachEvent("onunload", Tt)), w.attributes = i(function (e) {
                    ...
                    w.disconnectedMatch = R.call(e, "div"), R.call(e, "[s!='']:x"), P.push("!=", ot)
                }), F = F.length && new RegExp(F.join("|")), P = P.length && new RegExp(P.join("|")), t = mt.test(H.compareDocumentPosition), M = t || mt.test(H.contains) ? function (e, t) {
                        ...
                        return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === W && M(W, e) ? -1 : t === L || t.ownerDocument === W && M(W, t) ? 1 : j ? et(j, e) - et(j, t) : 0 : 4 & n ? -1 : 1)
                    } : function (e, t) {
                        if (e === t)return A = !0, 0;
            ...
            pseudos: {
                not: r(function (e) {
                    ...
                    return pt.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(bt, wt).toLowerCase(), function (t) {
                        var n;
    ...
    var ft = function (e, t, n) {
        ...
        return n
    }, dt = ot.expr.match.needsContext, ht = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, gt = /^.[^:#\[\.,]*$/;
    ...
    var xt = /^(?:parents|prev(?:Until|All))/, bt = {children: !0, contents: !0, next: !0, prev: !0};
    ot.fn.extend({
        has: function (e) {
            ...
            for (var n, r = 0, i = this.length, o = [], s = dt.test(e) || "string" != typeof e ? ot(e, t || this.context) : 0; i > r; r++)for (n = this[r]; n && n !== t; n = n.parentNode)if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && ot.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
        ...
        ot.fn[e] = function (n, r) {
            ...
            return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = ot.filter(r, i)), this.length > 1 && (bt[e] || ot.uniqueSort(i), xt.test(e) && i.reverse()), this.pushStack(i)
        }
    });
    var wt = /\S+/g;
        ...
        var t, n, r, i, s = [], a = [], u = -1, l = function () {
            ...
            add: function () {
                ...
                return ot.each(arguments, function (e, t) {
                    for (var n; (n = ot.inArray(t, s, n)) > -1;)s.splice(n, 1), u >= n && u--
                }), this
            }, has: function (e) {
    ...
    ot.fn.ready = function (e) {
        ...
        isReady: !1, readyWait: 1, holdReady: function (e) {
            ...
            (e === !0 ? --ot.readyWait : ot.isReady) || (ot.isReady = !0, e !== !0 && --ot.readyWait > 0 || (Tt.resolveWith(G, [ot]), ot.fn.triggerHandler && (ot(G).triggerHandler("ready"), ot(G).off("ready"))))
        }
    }), ot.ready.promise = function (t) {
        return Tt || (Tt = ot.Deferred(), "complete" === G.readyState || "loading" !== G.readyState && !G.documentElement.doScroll ? e.setTimeout(ot.ready) : (G.addEventListener("DOMContentLoaded", s), e.addEventListener("load", s))), Tt.promise(t)
    }, ot.ready.promise();
        ...
        register: function (e, t) {
            ...
            if (void 0 !== o) {
                if (void 0 === t) this.register(e); else {
                    ot.isArray(t) ? r = t.concat(t.map(ot.camelCase)) : (i = ot.camelCase(t), t in o ? r = [t, i] : (r = i, r = r in o ? [r] : r.match(wt) || [])), n = r.length;
                    for (; n--;)delete o[r[n]]
                }
    ...
    var Et = new a, Nt = new a, St = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Dt = /[A-Z]/g;
    ot.extend({
        hasData: function (e) {
        ...
        data: function (e, t) {
            ...
            return "object" == typeof e ? this.each(function () {
                    ...
                    var n, r;
                    if (o && void 0 === t) {
                        if (n = Nt.get(o, e) || Nt.get(o, e.replace(Dt, "-$&").toLowerCase()), void 0 !== n)return n;
        ...
        queue: function (e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;)n = Et.get(o[s], e + "queueHooks"), n && n.empty && (r++, n.empty.add(a));
            return a(), i.promise(t)
        }
    });
    var jt = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, At = new RegExp("^(?:([+-])=|)(" + jt + ")([a-z%]*)$", "i"), qt = ["Top", "Right", "Bottom", "Left"], Lt = function (e, t) {
        return e = t || e, "none" === ot.css(e, "display") || !ot.contains(e.ownerDocument, e)
    }, Ht = /^(?:checkbox|radio)$/i, Ot = /<([\w:-]+)/, Ft = /^$|\/(?:java|ecma)script/i, Pt = {
    ...
    !function () {
        ...
        n.setAttribute("type", "radio"), n.setAttribute("checked", "checked"), n.setAttribute("name", "t"), t.appendChild(n), rt.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked, t.innerHTML = "<textarea>x</textarea>", rt.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue
    }();
    var Mt = /^key/, It = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Wt = /^([^.]*)(?:\.(.+)|)/;
    ot.event = {
        global: {},
        add: function (e, t, n, r, i) {
            ...
            }), t = (t || "").match(wt) || [""], l = t.length; l--;)a = Wt.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (f = ot.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = ot.event.special[d] || {}, c = ot.extend({
                type: d,
                origType: g,
                data: r,
                handler: n,
        ...
        handlers: function (e, t) {
            ...
            if (a && u.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))for (; u !== this; u = u.parentNode || this)if (1 === u.nodeType && (u.disabled !== !0 || "click" !== e.type)) {
                for (r = [], n = 0; a > n; n++)o = t[n], i = o.selector + " ", void 0 === r[i] && (r[i] = o.needsContext ? ot(i, this).index(u) > -1 : ot.find(i, this, null, [u]).length), r[i] && r.push(o);
        ...
        fix: function (e) {
            ...
            for (s || (this.fixHooks[i] = s = It.test(i) ? this.mouseHooks : Mt.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new ot.Event(o), t = r.length; t--;)n = r[t], e[n] = o[n];
    ...
    var $t = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, Bt = /<script|<style|<link/i, _t = /checked\s*(?:[^=]|=\s*.checked.)/i, Xt = /^true\/(.*)/, zt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    ot.extend({
        htmlPrefilter: function (e) {
            ...
            for (var t, n, r, i = ot.event.special, o = 0; void 0 !== (n = e[o]); o++)if (kt(n)) {
                if (t = n[Et.expando]) {
        ...
        ot.fn[e] = function (e) {
            for (var n, r = [], i = ot(e), o = i.length - 1, s = 0; o >= s; s++)n = s === o ? this : this.clone(!0), ot(i[s])[t](n), K.apply(r, n.get());
    ...
    var Ut, Vt = {
        HTML: "block",
        BODY: "block"
    }, Yt = /^margin/, Gt = new RegExp("^(" + jt + ")(?!px)[a-z%]+$", "i"), Qt = function (t) {
    ...
    !function () {
        function t() {
            ...
            n = "1%" !== t.top, o = "2px" === t.marginLeft, r = "4px" === t.width, a.style.marginRight = "50%", i = "4px" === t.marginRight, Kt.removeChild(s)
        }
        ...
        a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", rt.clearCloneStyle = "content-box" === a.style.backgroundClip, s.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", s.appendChild(a), ot.extend(rt, {
            pixelPosition: function () {
                ...
                return n.style.cssText = a.style.cssText = "-webkit-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", n.style.marginRight = n.style.width = "0", a.style.width = "1px", Kt.appendChild(s), t = !parseFloat(e.getComputedStyle(n).marginRight), Kt.removeChild(s), a.removeChild(n), t
            }
        }))
    }();
    var Zt = /^(none|table(?!-c[ea]).+)/, en = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, tn = {
        letterSpacing: "0",
        fontWeight: "400"
    }, nn = ["Webkit", "O", "Moz", "ms"], rn = G.createElement("div").style;
    ot.extend({
        cssHooks: {
            opacity: {
                get: function (e, t) {
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = ot.camelCase(t), u = e.style;
                return t = ot.cssProps[a] || (ot.cssProps[a] = D(a) || a), s = ot.cssHooks[t] || ot.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = At.exec(n)) && i[1] && (n = l(e, t, i), o = "number"), null != n && n === n && ("number" === o && (n += i && i[3] || (ot.cssNumber[a] ? "" : "px")), rt.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u[t] = n)), void 0)
            }
        },
        css: function (e, t, n, r) {
            var i, o, s, a = ot.camelCase(t);
            return t = ot.cssProps[a] || (ot.cssProps[a] = D(a) || a), s = ot.cssHooks[t] || ot.cssHooks[a], s && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = N(e, t, r)), "normal" === i && t in tn && (i = tn[t]), "" === n || n ? (o = parseFloat(i), n === !0 || isFinite(o) ? o || 0 : i) : i
        }
        ...
        ot.cssHooks[t] = {
            get: function (e, n, r) {
                ...
                return s && (i = At.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n, n = ot.css(e, t)), j(e, n, s)
            }
        }
    }), ot.cssHooks.marginLeft = S(rt.reliableMarginLeft, function (e, t) {
        return t ? (parseFloat(N(e, "marginLeft")) || e.getBoundingClientRect().left - Jt(e, {marginLeft: 0}, function () {
                return e.getBoundingClientRect().left
            })) + "px" : void 0
    }), ot.cssHooks.marginRight = S(rt.reliableMarginRight, function (e, t) {
        return t ? Jt(e, {display: "inline-block"}, N, [e, "marginRight"]) : void 0
        ...
        }, Yt.test(e) || (ot.cssHooks[e + t].set = j)
    }), ot.fn.extend({
        css: function (e, t) {
        ...
        constructor: H, init: function (e, t, n, r, i, o) {
            this.elem = e, this.prop = n, this.easing = i || ot.easing._default, this.options = t, this.start = this.now = this.cur(), this.end = r, this.unit = o || (ot.cssNumber[n] ? "" : "px")
        }, cur: function () {
    ...
    ot.Animation = ot.extend(I, {
        ...
        fadeTo: function (e, t, n, r) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
                var t = !0, i = null != e && e + "queueHooks", o = ot.timers, s = Et.get(this);
                if (i) s[i] && s[i].stop && r(s[i]); else for (i in s)s[i] && s[i].stop && un.test(i) && r(s[i]);
    ...
    }, ot.fx.speeds = {slow: 600, fast: 200, _default: 400}, ot.fn.delay = function (t, n) {
        ...
        e.type = "checkbox", rt.checkOn = "" !== e.value, rt.optSelected = n.selected, t.disabled = !0, rt.optDisabled = !n.disabled, e = G.createElement("input"), e.value = "t", e.type = "radio", rt.radioValue = "t" === e.value
    }();
    ...
    ot.fn.extend({
        ...
        attr: function (e, t, n) {
            ...
            if (o && 1 === e.nodeType)for (; n = o[i++];)r = ot.propFix[n] || n, ot.expr.match.bool.test(n) && (e[r] = !1), e.removeAttribute(n)
        }
    }), ln = {
        set: function (e, t, n) {
    ...
    var fn = /^(?:input|select|textarea|button)$/i, pn = /^(?:a|area)$/i;
    ot.fn.extend({
        prop: function (e, t) {
        ...
        prop: function (e, t, n) {
            var r, i, o = e.nodeType;
            if (3 !== o && 8 !== o && 2 !== o)return 1 === o && ot.isXMLDoc(e) || (t = ot.propFix[t] || t, i = ot.propHooks[t]), void 0 !== n ? i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : e[t] = n : i && "get" in i && null !== (r = i.get(e, t)) ? r : e[t]
        }, propHooks: {
            tabIndex: {
                get: function (e) {
    ...
    ot.fn.extend({
        addClass: function (e) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(ot.isFunction(e) ? function (n) {
                        ...
                        var t, r, i, o;
                        if ("string" === n)for (r = 0, i = ot(this), o = e.match(wt) || []; t = o[r++];)i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else(void 0 === e || "boolean" === n) && (t = W(this), t && Et.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : Et.get(this, "__className__") || ""))
                    })
        }, hasClass: function (e) {
            var t, n, r = 0;
    ...
    ot.fn.extend({
        val: function (e) {
            var t, n, r, i = this[0];
            {
                ...
                if (i)return t = ot.valHooks[i.type] || ot.valHooks[i.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : (n = i.value, "string" == typeof n ? n.replace(hn, "") : null == n ? "" : n)
            }
        }
    }), ot.extend({
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, r = e.options, i = e.selectedIndex, o = "select-one" === e.type || 0 > i, s = o ? null : [], a = o ? i + 1 : r.length, u = 0 > i ? a : o ? i : 0; a > u; u++)if (n = r[u], !(!n.selected && u !== i || (rt.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && ot.nodeName(n.parentNode, "optgroup"))) {
                        if (t = ot(n).val(), o)return t;
                        s.push(t)
                    }
                    return s
                }, set: function (e, t) {
                    for (var n, r, i = e.options, o = ot.makeArray(t), s = i.length; s--;)r = i[s], (r.selected = ot.inArray(ot.valHooks.option.get(r), o) > -1) && (n = !0);
    ...
    ot.extend(ot.event, {
        trigger: function (t, n, r, i) {
            ...
            if (s = a = r = r || G, 3 !== r.nodeType && 8 !== r.nodeType && !mn.test(d + ot.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[ot.expando] ? t : new ot.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : ot.makeArray(n, [t]), f = ot.event.special[d] || {}, i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                ...
                for (o = 0; (s = p[o++]) && !t.isPropagationStopped();)t.type = o > 1 ? u : f.bindType || d, c = (Et.get(s, "events") || {})[t.type] && Et.get(s, "handle"), c && c.apply(s, n), c = l && s[l], c && c.apply && kt(s) && (t.result = c.apply(s, n), t.result === !1 && t.preventDefault());
                return t.type = d, i || t.isDefaultPrevented() || f._default && f._default.apply(p.pop(), n) !== !1 || !kt(r) || l && ot.isFunction(r[d]) && !ot.isWindow(r) && (a = r[l], a && (r[l] = null), ot.event.triggered = d, r[d](), ot.event.triggered = void 0, a && (r[l] = a)), t.result
            }
        }, simulate: function (e, t, n) {
            var r = ot.extend(new ot.Event, n, {type: e, isSimulated: !0});
            ot.event.trigger(r, null, t), r.isDefaultPrevented() && n.preventDefault()
        }
    }), ot.fn.extend({
    ...
    }), rt.focusin = "onfocusin" in e, rt.focusin || ot.each({focus: "focusin", blur: "focusout"}, function (e, t) {
        var n = function (e) {
    ...
    var vn = e.location, yn = ot.now(), xn = /\?/;
    ...
    var bn = /#.*$/, wn = /([?&])_=[^&]*/, Tn = /^(.*?):[ \t]*([^\r\n]*)$/gm, Cn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, kn = /^(?:GET|HEAD)$/, En = /^\/\//, Nn = {}, Sn = {}, Dn = "*/".concat("*"), jn = G.createElement("a");
    jn.href = vn.href, ot.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (t, n) {
            ...
            c = ot.event && p.global, c && 0 === ot.active++ && ot.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !kn.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (xn.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = wn.test(o) ? o.replace(wn, "$1_=" + yn++) : o + (xn.test(o) ? "&" : "?") + "_=" + yn++)), p.ifModified && (ot.lastModified[o] && T.setRequestHeader("If-Modified-Since", ot.lastModified[o]), ot.etag[o] && T.setRequestHeader("If-None-Match", ot.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Dn + "; q=0.01" : "") : p.accepts["*"]);
    ...
    var An = /%20/g, qn = /\[\]$/, Ln = /\r?\n/g, Hn = /^(?:submit|button|image|reset|file)$/i, On = /^(?:input|select|textarea|keygen)/i;
    ...
    var Fn = {0: 200, 1223: 204}, Pn = ot.ajaxSettings.xhr();
    rt.cors = !!Pn && "withCredentials" in Pn, rt.ajax = Pn = !!Pn, ot.ajaxTransport(function (t) {
        ...
        return rt.cors || Pn && !t.crossDomain ? {
                send: function (i, o) {
                    ...
                    n = function (e) {
                        return function () {
                            n && (n = r = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Fn[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                        }
        ...
        if (e.crossDomain) {
            ...
            return {
                send: function (r, i) {
                    t = ot("<script>").prop({charset: e.scriptCharset, src: e.url}).on("load error", n = function (e) {
    ...
    ot.ajaxSetup({
        ...
        return a || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = ot.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Mn, "$1" + i) : t.jsonp !== !1 && (t.url += (xn.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
                ...
                void 0 === o ? ot(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Rn.push(i)), s && ot.isFunction(o) && o(s[0]), s = o = void 0
            }), "script") : void 0
    ...
    ot.fn.load = function (e, t, n) {
        ...
        setOffset: function (e, t, n) {
            ...
            "static" === c && (e.style.position = "relative"), a = f.offset(), o = ot.css(e, "top"), u = ot.css(e, "left"), l = ("absolute" === c || "fixed" === c) && (o + u).indexOf("auto") > -1, l ? (r = f.position(), s = r.top, i = r.left) : (s = parseFloat(o) || 0, i = parseFloat(u) || 0), ot.isFunction(t) && (t = t.call(e, n, ot.extend({}, a))), null != t.top && (p.top = t.top - a.top + s), null != t.left && (p.left = t.left - a.left + i), "using" in t ? t.using.call(e, p) : f.css(p)
        }
    }, ot.fn.extend({
        offset: function (e) {
        ...
        rotate: function (t) {
            if (0 !== this.length && "undefined" != typeof t) {
                ...
                for (var i = [], e = 0, s = this.length; s > e; e++) {
                    var h = this.get(e);
                    if (h.Wilq32 && h.Wilq32.PhotoEffect) h.Wilq32.PhotoEffect._handleRotation(t); else {
...
$(function () {
    function start() {
        running || (rotateStart(), getOrderId())
    }

    function getOrderId() {
        var data = {token: _token, activityId: CFG.activityId};
        againOrderId && (data.againOrderId = againOrderId), window.xhr = $.ajax({
            url: CFG.doJoin,
            type: "post",
            dataType: "json",
            data: data,
            success: function (result) {
                window.lastResult = result, eval(result.token), result.success ? (againOrderId = null, postOrder(result.orderId)) : 1 == result.status ? rotateError("noLogin", result) : 2 == result.status ? rotateError("noCredits", result) : 3 == result.status ? rotateError("todayOver") : 4 == result.status ? rotateError("over") : 5 == result.status ? rotateError("gameClose") : rotateError("systemError", result)
            },
            error: function () {
                !timeout && rotateError("networkError")
            }
        })
    }
    ...
    function postOrder(t) {
        setTimeout(function () {
            window.xhr = $.ajax({
                ...
                data: {orderid: t},
                success: function (e) {
                    timeout || (window.lastResult = e, e.success ? -1 == e.result ? postOrder(t) : (e.againTag && (againOrderId = e.againTag), $(".needCredits span").html(e.needCreditsText), rotateFn(e)) : rotateError("systemError", e))
                },
                error: function () {
                    !timeout && rotateError("networkError")
                }
    ...
    function showModal(t, e) {
        var o = "", r = "", n = "", i = !1, a = "", l = {
            over: "//yun.duiba.com.cn/db-m/app/turntable/circle/images/over_e6027c4.png",
            networkError: "//yun.duiba.com.cn/db-m/app/turntable/circle/images/networkError_eaf7471.png",
            noCredits: "//yun.duiba.com.cn/db-m/app/turntable/circle/images/noCredits_2d7ca69.png",
            noPrize: ["//yun.duiba.com.cn/db-m/app/turntable/circle/images/noPrize1_c747da5.png", "//yun.duiba.com.cn/db-m/app/turntable/circle/images/noPrize2_c9439b1.png"],
            again: "//yun.duiba.com.cn/db-m/app/turntable/circle/images/again_9ecaf80.png"
        };
        switch (t) {
            case"systemError":
                o = "抽奖失败", r = e.message, n = l.over, i = !1, a = ".know";
                break;
            case"networkError":
                o = "网络解析错误", r = "请检查网络是否正常~", n = l.networkError, i = !1, a = ".know";
                break;
            case"noLogin":
                o = "未登录", r = "请先登录再来哦~", n = l.over, i = !1, a = ".login";
                break;
            case"gameClose":
                o = "活动已结束", r = "下次早点来把~", n = l.over, i = !1, a = ".know";
                break;
            case"noCredits":
                o = CFG.unitName + "不足", r = "赚足" + CFG.unitName + "后再来吧~", n = l.noCredits, i = !1, a = ".getCredits", $(".getCredits").off("click").on("click", function () {
                    window.location.href = e.getCreditsLink
                });
                break;
            case"over":
                o = "已抽完", r = "没有抽奖次数了，下次再来吧", n = l.over, i = !1, a = ".know";
                break;
            case"todayOver":
                o = "今日已抽完", r = "明天再来吧~", n = l.over, i = !1, a = ".know";
                break;
            case"noPrize":
                var c = l.noPrize;
                o = "没中奖", r = "别灰心再来一次吧~", n = c[random(0, 1)], i = !1, a = ".continue", $(".getPrize").off("click").on("click", function () {
                    window.location.href = e.lottery.link
                });
                break;
            case"again":
                o = "恭喜您", r = "获得了免费再来一次", n = l.again, i = !1, a = ".again";
                break;
            case"prize":
                o = "恭喜您", r = "获得了" + e.lottery.title, n = e.lottery.imgurl, i = !0, a = ".prize-continue,.getPrize", $(".getPrize").off("click").on("click", function () {
                    window.location.href = e.lottery.link
                })
        }
        "prize" == t ? $(".prize-modal-dialog header").find(".win").show() : $(".prize-modal-dialog header").find(".win").hide(), $(".prize-modal-dialog footer button").hide(), $(a).show();
        var d = $(".prize-modal-dialog section");
        d.find("h2").html(o), d.find(".tip").html(r), d.find("img").attr("src", n), i ? d.find(".block-help").show() : d.find(".block-help").hide(), setTimeout(function () {
            $(".prize-modal").show(), $("#db-content").addClass("filter-blur"), document.touchmove = function (t) {
                t.preventDefault()
            }
        }, 300)
    }
    ...
    function hideModal() {
        $(".prize-modal").hide(), $("#db-content").removeClass("filter-blur"), document.touchmove = null, running = !1
    }
    ...
    FastClick.attach(document.body), $(".probability-rules").on("click", function () {
        $(this).toggleClass("active"), $(window).scrollTop($(document).height() - $(window).height())
    }), $(".prize").on("click", function () {
        if (!isShouGongKe) {
            new GetPrizeDetail({
                url: "/hdtool/prizeDetail",
                prizeType: $(this).data("type"),
                data: {appItemId: $(this).data("appitemid"), itemId: $(this).data("itemid")}
            })
        }
    });
    var timeout = !1, running = !1, rotateStart = function () {
        timeout = !1, running = !0, $("#circle").rotate({
            angle: 0,
            animateTo: 2160,
            duration: 8e3,
            easing: function (t, e, o, r, n) {
                return -r * (e /= n) * (e - 2) + o
            },
            callback: function () {
                timeout = !0, window.xhr && window.xhr.abort(), showModal("networkError")
            }
        })
    }, rotateError = function (t, e) {
        $("#circle").stopRotate(), $("#circle").rotate({
        ...
        var e;
        $("#circle .prize").each(function () {
            return $(this).data("id") == t.lottery.id ? void(e = 45 * $(this).data("index")) : void 0
        }), e = 360 - e + 1800 + random(5, 40), $("#circle").stopRotate(), $("#circle").rotate({
            angle: getRotateAngle(),
            animateTo: e,
            duration: 8e3,
            callback: function () {
                0 == t.result ? showModal("noPrize") : 1 == t.result ? showModal("again") : "coupon" == t.lottery.type ? window.showCouponPrize({
                                prize: {
                                    img: t.lottery.imgurl,
                                    title: t.lottery.title,
                                    tip: t.lottery.tip,
                                    validate: t.lottery.validate,
                                    couponCode: t.lottery.coupon_code,
                                    couponKey: t.lottery.coupon_key,
                                    showUse: t.lottery.showUse,
                                    useBtnText: t.lottery.useBtnText,
                                    type: t.lottery.type,
                                    downloadAppConfig: {
                                        openUrl: t.lottery.openUrl,
                                        iosDownloadUrl: t.lottery.iosDownloadUrl,
                                        androidDownloadUrl: t.lottery.androidDownloadUrl
                                    },
                                    link: t.lottery.link
                                }
                            }) : showModal("prize", t)
    ...
    var againOrderId = null;
    $(".continue,prize-continue,.close,.know").on("click", function () {
        hideModal()
