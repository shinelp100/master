...
<head>
    ...
    <link rel="stylesheet" href="/static/default/css/newcss/investment.css?v=3.9">
...
<div class="flex-content">
    <div class="titlebar clearfix f12 swiper-container swiper-container1">
        <ul class="swiper-wrapper">
            <li class="lf selected swiper-slide" data-name="syz">收益中</li>
            <li class="lf swiper-slide" data-name="mjz">募集中</li>
            <li class="lf swiper-slide" data-name="yhq">已还清</li>
        </ul>
    </div>
    <div id="listcontent" class="list swiper-container swiper-container2">
